...
<li class='field_block' id='field_0_div'><div class='col_label'>
	<label class='form_field'>My email address is...</label> <label class='form_required' >*</label> </div>
	<div class='col_field'>
...
<li class='field_block' id='field_1_div'><div class='col_label'>
	<label class='form_field'>My message is about...</label> <label class='form_required' >&nbsp;</label> </div>
	<div class='col_field'>
...
<li class='field_block' id='field_2_div'><div class='col_label'>
	<label class='form_field'>Here's my message...</label> <label class='form_required' >*</label> </div>
	<div class='col_field'>
...
<!-- CAPTCHA SECTION STARTS HERE 
    ...
    UNCOMMENT IF NECESSARY FOR FUNCTIONALITY !-->
	...
	<div class='col_label'></div><div class='col_field'>
        <?php phpfmg_show_captcha(); ?>
            ...
            <div id='err_required' class="form_error" style='display:none;'>
                <label class='form_error_title'>Who you are, and what you have to say are important. Don't be shy!</label>
            </div>
            <div class='col_label'>&nbsp;</div>
            <div class='form_submit_block col_field'>
                <div id="hollerContainer">
	

                <input type='submit' value='Holler' class='form_button'>
            </div>
...
You are awesome. <br>
I'll definitely get back to you <br>
👍
</div>
